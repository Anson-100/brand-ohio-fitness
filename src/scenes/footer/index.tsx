        ...
        <div className="flex flex-col justify-center items-center gap-6 pt-6">
          <div className="flex flex-col items-center justify-center ">
            <div className="flex flex-col items-center justify-center gap-6">
              <img src={ITLogo} alt="IT Logo" className="w-28 md:w-32 mb-4" />{" "}
              <div className="flex gap-4 items-center justify-center">
                <div
                  aria-label="Footer"
                  className=" flex flex-wrap items-center justify-center gap-x-12 gap-y-3 text-sm/6"
                >
                  <LinkFooter
                    page="Fitness"
                    selectedPage={selectedPage}
          ...
          <div className="flex flex-col ">
            ...
            <p className="text-center text-gray-500 text-sm md:text-base px-2">
