...
const ContactUs = ({}: Props) => {
  ...
  const boxStyle =
    "bg-gradient-to-br from-zinc-800 to-zinc-900 border border-l-zinc-700 border-t-zinc-700 border-r-zinc-900 border-b-zinc-900 rounded-sm shadow-lg  flex items-center  h-24 md:h-32"
  return (
          ...
          <div className="md:w-1/3 flex flex-col pt-[2rem] md:pt-[7rem] gap-6 text-center md:text-left mb-10 md:mb-0">
            ...
            >
              <p className="w-3/4 mx-auto md:mx-0 mb-8">
                ...
                Filling out a waiver online is the best way to avoid wait times
                during business hours. We look forward to hearing from you!
              </p>
            </motion.div>
          </div>
